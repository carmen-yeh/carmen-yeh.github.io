...
function LoveLanguagePage() {
    ...
    return(
        ...
        <div id = 'lovelanguage'>
            ...
            <LoveBox paddingLeft={10} text={"Love You"} verticalSpace={10}/>
            <LoveBox paddingLeft={80} text={"Me too"} verticalSpace={10}/>
            <LoveBox paddingLeft={40} text={"I know you love me already"} verticalSpace={20}/>
