...
function HappyBirthdayPage() {
    ...
    return(
        ...
        <p>HAPPY.BIRTHDAY explores the idea of making meaningful posts through analysing how frequent I post a ‘generic’ birthday message. This experiment was formed through conducting reading analysis of posts where each birthday message is highlighted by a white dot. What counts as a meaningful post?</p>
            ...
            <BirthdayDot paddingLeft={10} divSize={100} paddingTop={0}/>
            <BirthdayDot paddingLeft={50} divSize={100} paddingTop={50}/>
            <BirthdayDot paddingLeft={90} divSize={100} paddingTop={20}/>
            <BirthdayDot paddingLeft={40} divSize={100} paddingTop={70}/>
            <BirthdayDot paddingLeft={60} divSize={100} paddingTop={10}/>
            <BirthdayDot paddingLeft={30} divSize={100} paddingTop={20}/>
            <BottomNavigation />
        <div id= "footer">  
