    ...
    return(
        <div id='background-blue'>
            ...
            <TopNavigation/>
                ...
                {size && <img src={poem2} alt={"poem"} style={{width: "100vw", paddingLeft: 0, paddingRight: 0, paddingTop: 0}} />}
                {!size && <img src={poem1} alt={"poem"} style={{width:"100vw", paddingLeft: 0, paddingRight: 0, paddingTop: 0}} />}
